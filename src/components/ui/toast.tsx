...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      px-3 text-sm font-medium transition-colors hover:bg-secondary focus:outline-none focus:ring-1 focus:ring-ring 
      ...
      group-[.success]:hover:bg-success group-[.success]:hover:text-success-foreground group-[.success]:focus:ring-success
      `,
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={cn(
      ...
      focus:opacity-100 focus:outline-none focus:ring-1 group-hover:opacity-100 group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50 
      group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600
      group-[.success]:text-red-300 group-[.success]:hover:text-red-50 
      group-[.success]:focus:ring-red-400 group-[.success]:focus:ring-offset-red-600
      `,
      className
    )}
    toast-close=""
